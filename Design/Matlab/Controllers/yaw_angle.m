...
yaw_angle_controller_tf         = 0.74857 * (s + 0.175) / s                % PI
...
plot(tout, yawref, 'LineWidth', 2)
plot(toutnoise, yawnoise(:, 3), 'LineWidth', 2)
plot(tout, euler_angles_rad_no_noise(:, 3), 'LineWidth', 2)
...
% % plot(tout, yaw_angle_pi_control_nl_no.Data, 'LineWidth', 2)
% % plot(tout, yaw_angle_pid_control_nl_no.Data, 'LineWidth', 2)
% % plot(tout, yaw_angle_pi_control_l_no.Data, 'LineWidth', 2)
% % plot(tout, yaw_angle_pid_control_l_no.Data, 'LineWidth', 2)
% 
% plot(tout, yaw_angle_pi_control_nl_o.Data, 'LineWidth', 2)
% plot(tout, yaw_angle_pid_control_nl_o.Data, 'LineWidth', 2)
% 
% yl = ylim;
% % plot(zeros(2001, 1)+20, -1000:1000, 'k--', 'LineWidth', 2);               %Plot Disturbance injection
% 
% xlabel('Time (seconds)', 'FontSize', 20)
% ylabel('Amplitude', 'FontSize', 20)
% % legend({'Reference', 'PI Controller excl. limits', 'PID Controller excl. limits', 'PI Controller incl. limits', 'PID Controller incl. limits'}, 'FontSize', 16);
% legend({'Reference', 'PI Controller incl. offset', 'PID Controller incl. offset'}, 'FontSize', 16);
% % title('Heave Controller - Step Responses', 'FontSize', 20)
% ylim(yl)
% grid on;
% 
...
% figure;
% hold on;
% plot(tout, desired_yaw_pi.Data, 'LineWidth', 2)
% plot(tout, desired_yaw_pid.Data, 'LineWidth', 2)
% grid on;
