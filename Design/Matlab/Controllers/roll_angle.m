...
roll_angle_controller1_tf   = 1.8                                         %P

roll_angle_controller_name  = 'PD Controller'
roll_angle_controller1_name = 'P Controller'
...
legend({'Unity Feedback', roll_angle_controller_name, roll_angle_controller1_name, 'Crossover Frequencies'},'FontSize', 16);
hold off;
