...
north_position_controller_tf        = 0.68274;
north_position_controller1_tf       = 0.68274;

north_position_controller_name      = 'P Controller'
north_position_controller1_name     = 'PD Controller'

transfer_function           = north_position_controller_tf*north_position_tf;
transfer_function1          = north_position_controller1_tf*north_position_tf;
...
step(feedback(north_position_tf, 1), 'b')
step(feedback(transfer_function, 1), 'r')
step(feedback(transfer_function1, 1), 'g')

xlabel('Time (seconds)', 'FontSize', 20)
ylabel('Amplitude', 'FontSize', 20)
legend({'Unity Feedback', north_position_controller_name, north_position_controller1_name}, 'FontSize', 16);
...
legend({'Unity Feedback', north_position_controller_name, north_position_controller1_name, 'Crossover Frequencies'},'FontSize', 16);
hold off;
