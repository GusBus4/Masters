...
%   Detailed explanation goes here
    ...
    global roll_rate_derivative roll_rate_last_input roll_rate_kD
    ...
    if limit_roll_pitch == 0 || (integrator > 0 && roll_rate_error_rads < 0) || (integrator < 0 && roll_rate_error_rads > 0) 
        ...
        if (roll_rate_kI > 0 && dt > 0)
            ...
            roll_rate_integrator = roll_rate_integrator + ((roll_rate_last_input * roll_rate_kI) * dt);
    ...
    roll_rate_proportional = roll_rate_kP * roll_rate_last_input;
